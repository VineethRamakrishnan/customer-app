...
public class CustomerController {
	...
	public List<Customer> getCustomersByAddressAndAge(@PathVariable(value = "address") String address,
	...
	public Customer updatePointsByStoredProcedure(@PathVariable(value = "id") Long customerId,
			@PathVariable(value = "points") Double newPoints) {
